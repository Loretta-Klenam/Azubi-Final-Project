...
class DetectorReference:
    def __init__(self, *, detector_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__a6848940a92fe8e3f1b7d2a28726632a221ce0a619e2c64e5df120828856586d)
...
class FilterReference:
    def __init__(self, *, detector_id: builtins.str, filter_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__40a6a0607715206f75856f58b609f4d0f2ab541e158d64ff80aed19f11b6e800)
            check_type(argname="argument detector_id", value=detector_id, expected_type=type_hints["detector_id"])
...
class IPSetReference:
    def __init__(self, *, detector_id: builtins.str, ip_set_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__92295c4c80bd4b1d49687be1b4b124ec6aa6a5aae9d1493831e74ffd7e126607)
            check_type(argname="argument detector_id", value=detector_id, expected_type=type_hints["detector_id"])
...
class MalwareProtectionPlanReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__cf739c1a65de202429a81c2fe429c52e9f56cca3f91ae8a0289abff4cc071e18)
...
class MasterReference:
    def __init__(self, *, detector_id: builtins.str, master_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__8925c87309782f1d27c270c8ef60db4201e6d039d173f7a922e65624c31e698d)
            check_type(argname="argument detector_id", value=detector_id, expected_type=type_hints["detector_id"])
...
class MemberReference:
    def __init__(self, *, detector_id: builtins.str, member_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__fe3803ae846d896367d0ee685365bdf27278225aabe845f4e5c38236a035fb2c)
            check_type(argname="argument detector_id", value=detector_id, expected_type=type_hints["detector_id"])
...
class PublishingDestinationReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__1954f15495f4cad5d31e277ccfc284aa7f40f23cb69b85bdde91bf1eaac051c2)
            check_type(argname="argument detector_id", value=detector_id, expected_type=type_hints["detector_id"])
...
class ThreatEntitySetReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__aae63dd921bfcf536f90c2c782a441d5c2789e4a69148a93c1b8ba5394eb4557)
            check_type(argname="argument detector_id", value=detector_id, expected_type=type_hints["detector_id"])
...
class ThreatIntelSetReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__ece76fe64cc90a7d7106df815cf9342cfa0797da775897e9160e724be24c64b4)
            check_type(argname="argument detector_id", value=detector_id, expected_type=type_hints["detector_id"])
...
class TrustedEntitySetReference:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = cached_type_hints(_typecheckingstub__092bff2af5d8810173beb35221a3505f0dcd23bb88ae6dc1a71baf99b6e9476b)
            check_type(argname="argument detector_id", value=detector_id, expected_type=type_hints["detector_id"])
