...
export default function PromptCard() {
  ...
  return (
    <div className="relative w-[701px] max-md:w-[calc(100vw-48px)] min-h-[208px] bg-white/[0.06] border-[3px] border-white rounded-[44px] shadow-[0_0_4px_0_rgba(0,0,0,0.15)] overflow-hidden backdrop-blur-[20px]">
      {/* Prompt text */}
      <p className="absolute left-[29px] top-[57px] -translate-y-1/2 w-[609px] max-md:w-[calc(100%-58px)] font-sans text-xl max-md:text-[17px] font-medium text-evendor-prompt leading-relaxed break-words">
      ...
      >
        <Upload className="w-[18px] h-[18px] text-evendor-text flex-shrink-0" />
      </button>
